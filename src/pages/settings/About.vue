<template>
  <div class="settings-subpage">
    ...
    <div class="about-content">
      ...
      <p class="about-license">MIT</p>

      <div class="about-links">
        <a href="https://github.com/gncysy/AbyssReader" target="_blank" rel="noopener noreferrer" class="about-link">
      ...
      <button class="btn-check-update" :disabled="checking" @click="checkForUpdate">
...
async function checkForUpdate() {
  ...
  try {
    const res = await fetch('https://api.github.com/repos/gncysy/AbyssReader/releases?per_page=5', {
